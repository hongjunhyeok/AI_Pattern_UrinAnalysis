...
3. Tensorflow를 이용한 질병진단의 경우  실검환자데이터를 충분히 확보하지 못해 예상보다 저조한 정확도를 보였다.

결론적으론 75%수준의 정확도를 보여 기대에 못미치는 수준이었으며 예상되는 문제점은 다음과 같다.
  ...
  다만 이러한 문제점은 데이터베이스를 활용한 업데이트와 추가적인 데이터의 확보를 통해 정확도향상을 진행할 수 있을 것으로 판단한다.
