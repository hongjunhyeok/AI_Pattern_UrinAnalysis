...
public class menu_protein extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_protein);

        AnyChartView anyChartView = findViewById(R.id.any_chart_protein);
        ...
        try {
            ...
            list_protein =folderUtil.fileRead("pr.txt");



            for(int i=0;i<list_protein.size();i++){
                seriesData.add(new CustomDataEntry(String.format("%d차측정",i+1),list_protein.get(i)));
            }
