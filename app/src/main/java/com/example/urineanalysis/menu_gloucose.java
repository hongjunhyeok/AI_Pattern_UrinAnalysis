...
public class menu_gloucose extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_gloucose);

        AnyChartView anyChartView = findViewById(R.id.any_chart_gloucose);
        ...
        try {
            ...
            list_gloucose =folderUtil.fileRead("gl.txt");



            for(int i=0;i<list_gloucose.size();i++){
                seriesData.add(new menu_gloucose.CustomDataEntry(String.format("%d차 측정",i+1),list_gloucose.get(i)));
