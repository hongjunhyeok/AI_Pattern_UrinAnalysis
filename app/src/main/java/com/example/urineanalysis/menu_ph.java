...
public class menu_ph extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_ph);

        AnyChartView anyChartView = findViewById(R.id.any_chart_ph);
        ...
        try {
            ...
            list_ph =folderUtil.fileRead("ph.txt");



            for(int i=0;i<list_ph.size();i++){
                seriesData.add(new CustomDataEntry(String.format("%d차 측정",i+1),list_ph.get(i)));
            }
